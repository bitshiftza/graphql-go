# graphql-go [![Sourcegraph](https://sourcegraph.com/github.com/bitshiftza/graphql-go/-/badge.svg)](https://sourcegraph.com/github.com/bitshiftza/graphql-go?badge) [![Build Status](https://semaphoreci.com/api/v1/graph-gophers/graphql-go/branches/master/badge.svg)](https://semaphoreci.com/graph-gophers/graphql-go) [![GoDoc](https://godoc.org/github.com/bitshiftza/graphql-go?status.svg)](https://godoc.org/github.com/bitshiftza/graphql-go)
...
- subscriptions
   - [sample WS transport](https://github.com/bitshiftza/graphql-transport-ws)

## Roadmap

We're trying out the GitHub Project feature to manage `graphql-go`'s [development roadmap](https://github.com/bitshiftza/graphql-go/projects/1).
...
import (
        ...
        graphql "github.com/bitshiftza/graphql-go"
        "github.com/bitshiftza/graphql-go/relay"
)
...
### [Examples](https://github.com/bitshiftza/graphql-go/wiki/Examples)

### [Companies that use this library](https://github.com/bitshiftza/graphql-go/wiki/Users)
